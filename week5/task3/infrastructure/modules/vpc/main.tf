...
resource "aws_subnet" "private" {
  ...
  tags = {
    Name = "task3-private-${count.index}"
  }
}
...
resource "aws_subnet" "isolated" {
  ...
  tags = {
    Name = "task3-isolated-${count.index}"
  }
}
